  ...
  self.define = (n, c, i) => {
    s[n] ||
      (s[n] = Promise.resolve().then(() => {
        let s = {};
        const a = { uri: location.origin + n.slice(1) };
        return Promise.all(
          c.map((n) => {
            switch (n) {
              case "exports":
      ...
      [
        {
          ...
          revision: "hVncvUplsnZQmwFicQn8G",
        },
        {
        ...
        {
          url: "/_next/static/chunks/6.1f21634609a5f25dfaac.js",
          revision: "hVncvUplsnZQmwFicQn8G",
        },
        {
        ...
        {
          url: "/_next/static/chunks/webpack-d13bf2d81ea23d12e9e1.js",
          revision: "hVncvUplsnZQmwFicQn8G",
        },
        {
        ...
        {
          url: "/_next/static/hVncvUplsnZQmwFicQn8G/_buildManifest.js",
          revision: "hVncvUplsnZQmwFicQn8G",
        },
        {
          url: "/_next/static/hVncvUplsnZQmwFicQn8G/_ssgManifest.js",
          revision: "hVncvUplsnZQmwFicQn8G",
        },
